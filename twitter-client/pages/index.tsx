    ...
    <div className={inter.className}>
      <div className="grid grid-cols-12 h-screen w-screen px-56">
        <div className="col-span-3 pt-8 px-4">
          <div className="text-4xl hover:bg-gray-800 rounded-full p-4 w-fit h-fit cursor-pointer transition-all">
            <BsTwitter />
          </div>
          <div className="mt-4 text-2xl pr-4">
            ...
            <div className="mt-5 px-3">
              <button
                type="button"
                className="bg-[#1d9bf0] p-4 rounded-full w-full text-lg font-semibold"
              >
                Tweet
              </button>
            </div>
